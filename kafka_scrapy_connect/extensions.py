...
class KafkaLogStats:
    ...
    def get_response_status_counts(self):
        ...
        """
        status_codes = ['200', '201', '202', '204', '300', '301', '302', '303', '400', '401', '403']
        return {code: self.stats.get_stats().get(f"downloader/response_status_count/{code}", 0) for code in status_codes}
